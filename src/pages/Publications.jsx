  ...
  if (
    ...
    return (
      <>
        ...
        <Helmet>
          <title>
            [Research] Bangladeshi July Revolution & Visual Representation
            Impacts: A Film Impact Aspect
          </title>
          <meta
            name="description"
            content="Bangladeshi July Revolution & Visual Representation Impacts: A Film Impact
      Aspect - Saad Al Amin Research Paper"
          />
        </Helmet>
