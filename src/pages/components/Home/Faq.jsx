...
export default function Faq({ limited }) {
 ...
 return (
  <div className="text-dark py-5" style={{ backgroundColor: "#111" }}>
   <section className="bsb-faq-3 py-3 py-md-5 py-xl-8">
    <div className="container">
     <div className="row justify-content-md-center">
      <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
       <h2 className="mb-4 display-6 fw-medium text-center text-light">
        Frequently Asked Questions
       </h2>
       <p className="mb-5 text-center text-light">
        Explore answers to common questions about Saad Al Amin, his work, and
        more.
       </p>
      </div>
     </div>
