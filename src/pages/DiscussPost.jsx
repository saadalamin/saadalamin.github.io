      ...
      <div className="row">
       ...
       >
          ...
          <div className="d-sm-flex gap-4">
           ...
           <div>
            <span style={{ color: "#aaa" }}>
             Saad Al Amin, {convertDateToText(post.answer.date || new Date())}
            </span>
            <p className="mt-2" style={{ fontSize: "0.98rem" }}>
             {post.answer.body || "No answer found!"}
            </p>
             ...
             <button
              ...
              onClick={() => {
               ...
               if (_b) {
                editAnswer(
                 postId,
                 { body: _b, date: $timestamp(new Date()) },
                 () => {
                  setPost({
                   ...post,
                   answer: {
        ...
        <section
         ...
         style={{
          display: isLoggedIn
           ? (post.answer && typeof post.answer !== "object") ||
             (typeof post.answer === "object" &&
              Object.keys(post.answer).length === 0)
             ? "block"
             : "none"
           : "none",
         }}
